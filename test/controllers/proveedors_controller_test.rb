...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { cuanto_tarda: @proveedor.cuanto_tarda, nombre: @proveedor.nombre, saldo: @proveedor.saldo, user_id: @proveedor.user_id }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { cuanto_tarda: @proveedor.cuanto_tarda, nombre: @proveedor.nombre, saldo: @proveedor.saldo, user_id: @proveedor.user_id }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
